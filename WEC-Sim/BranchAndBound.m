...
%solvedNodes{1}.u = [0.3600; 0.7072; 0.2152; 0.4350];
solvedNodes{1}.u

tic
% cost = dynamics(zeros(timeSteps*2,1),params);
cost = dynamics(solvedNodes{1}.u,params);
toc
...
capP = u_discrete_cap.Data;
rodP = u_discrete_rod.Data;
...
capLoss = SwitchingLoss(capP,theta_discrete.Data,thetaDot_discrete.Data,'cap',params.capArea,params.r);
rodLoss = SwitchingLoss(rodP,theta_discrete.Data,thetaDot_discrete.Data,'rod',params.rodArea,params.r);
...
if params.plotFigures
    ...
    figure, plot(t,TorquePTO,t,-1*(Kp*thetaDotOpt_Theory + Ki*thetaOpt_Theory)), ylabel('PTO Torque [Nm]'), xlabel('Time [s]'), %legend('Numerical Optimization','CCC'), grid
